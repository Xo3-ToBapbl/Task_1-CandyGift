...
namespace CandyGift.Static
{
    public static class StaticFunctions
    {
        public static void CreateSweetCandies(XElement element, ref List<Candy> candies_list)
        {
        ...
        public static void CreateSaltedCandies(XElement element, ref List<Candy> candies_list)
        {
            string name = element.Element("Name").Value;
            int mass = Convert.ToInt32(element.Element("Mass").Value);
        ...
        public static void CreateXML(ICollection<Candy> candies)
        {
        ...
        public static List<Candy> LoadXML()
        {
        ...
        public static Dictionary<Candy, int> CreateGiftDict(List<Candy> candies_list)
        {
